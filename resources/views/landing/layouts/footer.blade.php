 ...
 <div class="map">
     <iframe
         src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d23737.220233327054!2d119.42796736732095!3d-5.160809155497818!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dbee329d96c4671%3A0x3030bfbcaf770b0!2sMakassar%2C%20Kota%20Makassar%2C%20Sulawesi%20Selatan!5e0!3m2!1sid!2sid!4v1740241786662!5m2!1sid!2sid"
             ...
             <div class="row gy-5">
                 <div class="col-xl-6 pe-xxl-5" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                     <div class="bg-white-01 tw-rounded-xl p-lg-5 tw-p-6 position-relative z-1">
                         <img src="assets-landing/images/shapes/contact-box-shape.png" alt=""
                             class="position-absolute top-0 tw-end-0 h-100 z-n1">

                         <img src="{{ asset('pemkot.png') }}" style="width: 100px" alt="">
                         <p class="text-neutral-50 fw-semibold cursor-small mt-3">Taurungka: Satu Data Pemuda
                             Kota Makassar, Sulawesi Selatan</p>
                 ...
                 <div class="col-xl-3 ps-xxl-5" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                     <div class="d-flex flex-column flex-wrap tw-gap-10">
                         <div class="">
                             <h5 class="text-white tw-mb-6 cursor-big splitTextStyleTwo">Alamat</h5>
                             <p class="position-relative text-neutral-500 fw-semibold cursor-small">Unit GA.9 No. 9-11
                                 Gedung Mall Graha Tata Cemerlang (Mall GTC) di Jalan Metro Tanjung Bunga, Kota Makassar
                             </p>
                         </div>
                         <div class="">
                             <h5 class="text-white tw-mb-6 cursor-big">Contact</h5>
                             <a href="mailto:dispora@makassarkota.go.id"
                                 class="cursor-small hover--translate-x-2 position-relative text-neutral-500 hover-text-main-600 fw-semibold">dispora@makassarkota.go.id</a>
                             <a href="tel:+62 823-9340-8606"
                                 class="cursor-big hover--translate-x-2 tw-mt-2 fw-bold position-relative text-main-600 tw-text-2xl hover-text-main-700 fw-semibold">+62
                                 823-9340-8606</a>
                         </div>
                     </div>
                 </div>
                 <div class="col-xl-3 ps-xxl-5" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                     <div class="d-flex flex-column flex-wrap tw-gap-10">
                         <div class="">
                             <h5 class="text-white tw-mb-6 cursor-big splitTextStyleTwo">Social</h5>
                             <ul class="cursor-small d-flex align-items-center tw-gap-3 tw-mt-6">
                                 <li>
