                            ...
                            <form class="form-data" enctype="multipart/form-data">
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="image-input image-input-empty" data-kt-image-input="true"
                                        style="background-image: url(/public/icon/{{ $data->icon }})">
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('admin/update-daftarmakassar/') }}" + lastPart,
                ...
                success: function(response) {
                    ...
                    if (response.success == true) {
                        swal
                            .fire({
                                text: `Daftar makassar dalam angka berhasil di Edit`,
                                icon: "success",
                                showConfirmButton: false,
                                timer: 1500,
                            })
                            .then(function() {
                                window.location.href = "{{ url('admin/daftarmakassar') }}";
                            });
                    } else {
                        $("form")[0].reset();
