        ...
        <div class="card w-100">
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        <label class="form-label">Proyeksi</label>
                        <input type="text" name="proyeksi" class="form-control">
                        <small class="text-danger proyeksi_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Nilai Hasil Capaian</label>
                        <input type="text" id="capaian" class="form-control" name="capaian">
                        <small class="text-danger capaian_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Proyeksi dan Hasil Capaian');
        })
        ...
        const initDatatable = async (year) => {
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Proyeksi dan Hasil Capaian" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
