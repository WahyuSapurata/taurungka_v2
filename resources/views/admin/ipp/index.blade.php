            ...
            $('#kt_table_data').DataTable({
                ...
                columns: [{
                    ...
                    render: function(data, type, row) {
                        ...
                        if (!indikator || typeof indikator !== 'object') return '-';

                        const values = Object.values(indikator).map(parseFloat).filter(v => !
                            isNaN(v));
                        ...
                        return average.toFixed(2); // tampilkan 2 angka di belakang koma
                    }
                }, {
                    data: 'uuid',
                }],
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            <div class="d-flex gap-2" style="flex-flow: wrap;">
                                ...
                                <a href="javascript:;" type="button" data-uuid="${data}" data-label="IPP" class="btn btn-danger button-delete btn-icon btn-sm">
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
